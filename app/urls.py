...
from .views import ProductList, ProductDetail, ProductCreate, ProductUpdate, ProductDelete, CustomLoginView, RegisterPage, vender_produto
from django.contrib.auth.views import LogoutView

urlpatterns = [
  path('product/<int:pk>/vender/', vender_produto, name='vender_produto'),
